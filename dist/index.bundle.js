...
class Task {
  ...
  constructor(task, date) {
    this.#task = task;
    this.#date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(date, "MM-dd-yyyy");
    this.completed = false;
    this.remainingDays = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.differenceInCalendarDays)(this.#date, currentDate);
  ...
  set date(newDate) {
    let tempDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(newDate, "MM-dd-yyyy");
    this.#date = tempDate;
  }
