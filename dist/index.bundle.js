...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/differenceInCalendarDays.mjs");


const currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(), "MM-dd-yyyy");

class Task {
  description;
  constructor(task, date) {
    this.title = task;
    this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(date, "MM-dd-yyyy");
    this.completed = false;
    this.remainingDays = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.differenceInCalendarDays)(this.dueDate, currentDate);
  ...
  changeDueDate(newDueDate) {
    this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(newDueDate, "MM-dd-yyyy");
  }
...
const firstProj = new Project("Build todo list");
firstProj.addNewTask("Kill the world", "october 15 2028");
firstProj.addNewTask("finish odin", "june 6 2024");
firstProj.addNewTask("jealousy dance", "april 1 2026");
firstProj.addNewTask("bakflip", "dec 3 2024");

console.log(firstProj);
console.log(firstProj.taskList);
firstProj.removeTask(2);
console.log(firstProj.taskList);
